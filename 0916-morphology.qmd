...
We will build upon the R code we introduced in the last class [Introduction to working with ELAN files in R in R Studio](https://mcdonn.github.io/2025-750g-corpus/0911-introduction-elan-r.html) using [`phonfieldwork`](https://docs.ropensci.org/phonfieldwork/) package to import ELAN `.eaf` files.
